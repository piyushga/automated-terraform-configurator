...
//     const vmId = outputs?.vm_id?.value ?? outputs?.vm_id ?? null;
//     const publicIp = outputs?.public_ip?.value ?? outputs?.public_ip ?? null;

//     const terraformDownloadUrl =
//         state.jobId
//             ? `${import.meta.env.VITE_API_BASE_URL}/terraform/azure/${state.jobId}/download`
//             : null;
...
//                         <div className="font-medium">{vmId ?? "N/A"}</div>
...
//                             {state.error ?? JSON.stringify(state.raw)}
//                         </pre>
//                     </div>
//                 )}
